...
This lab is not required for the module but has been left in case you want to try it for yourself. It still refers to the Travis CI environment which we are no longer using for the module and has not been updated for GitHub Actions. This lab is very involved and will take time, patience, and practice to complete and understand.  We are going to deploy our built software.  We will look at two methods:
